...
<form action="updatebook" method="post" enctype="multipart/form-data" files="true">
    ...
    <?php endif; ?>
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control" name="book_image" id="book_image"  files="true">
        </div>
        <div class="form-group">
            <label for="book_PDF">Book Online PDF *</label>
            <input type="file" class="form-control" name="book_PDF" id="book_PDF" files="true" >
        </div>
